...
/**
 * @see https://www.w3.org/TR/2026/CRD-css-color-4-20260331/#funcdef-rgb
 *
 * ```plaintext
 * rgb() = [ <legacy-rgb-syntax> | <modern-rgb-syntax> ]
 * ```
 */
export type Rgb = LegacyRgbSyntax | ModernRgbSyntax;

/**
 * @see https://www.w3.org/TR/2026/CRD-css-color-4-20260331/#typedef-legacy-rgb-syntax
 *
 * ```plaintext
 ...
 * ```
 */
export class LegacyRgbSyntax extends Css.Func {
  constructor(
    red: CssPercentage,
    green: CssPercentage,
    blue: CssPercentage,
...
/**
 * @see https://www.w3.org/TR/2026/WD-css-color-5-20260325/#typedef-modern-rgb-syntax
 *
 * ```plaintext
 ...
 * ```
 */
export class ModernRgbSyntax extends Css.Func {
  constructor(
  ...
  constructor(
    ...
    super("rgb", [new Css.SpaceList(vals)]);
  }
}
