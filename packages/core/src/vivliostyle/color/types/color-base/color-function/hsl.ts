...
/**
 * @see https://www.w3.org/TR/2026/CRD-css-color-4-20260331/#funcdef-hsl
 *
 * ```plaintext
 * hsl() = [ <legacy-hsl-syntax> | <modern-hsl-syntax> ]
 * ```
 */
export type Hsl = LegacyHslSyntax | ModernHslSyntax;

/**
 * @see https://www.w3.org/TR/2026/CRD-css-color-4-20260331/#typedef-legacy-hsl-syntax
 *
 * ```plaintext
 * <legacy-hsl-syntax> = hsl( <hue>, <percentage>, <percentage>, <alpha-value>? )
 * ```
 */
export class LegacyHslSyntax extends Css.Func {
  constructor(
    hue: Hue,
...
/**
 * @see https://www.w3.org/TR/2026/WD-css-color-5-20260325/#typedef-modern-hsl-syntax
 *
 * ```plaintext
 ...
 * ```
 */
export class ModernHslSyntax extends Css.Func {
  constructor(
  ...
  constructor(
    ...
    super("hsl", [new Css.SpaceList(vals)]);
  }
}
